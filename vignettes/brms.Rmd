...
# However, the fits in this example are very quick to fit
# so the overhead of transferring data between sessions 
# likely outweights the gains on most machines
...
which(!vapply(results$fits, is.brmsfit , FUN.VALUE = TRUE))
```
