...
```{r}
results_func <- compute_results(datasets_func, backend_func, thin_ranks = 10, gen_quants = log_lik_gq_func)
```
...
```{r}
results_func2 <- compute_results(datasets_func, backend_func2, thin_ranks = 10, gen_quants = log_lik_gq_func)
```
