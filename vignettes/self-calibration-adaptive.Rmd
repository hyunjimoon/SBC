...
lambda_mu <- 1 #11000.7617#1
lambda_sigma <- 0.1 #1000 #exp(2.536367)#10
...
# learning rate
gamma <- 10 # 0.5 for gradient update, 10 for normal_str_update
...
sc_opt <- self_calib_adaptive(calib_generator, backend_gr_opt, updator, "eta", lambda_mu, lambda_sigma, nsims, gamma, tol, fixed_args = fixed_args_gamma)
