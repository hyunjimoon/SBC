...
if(use_cmdstanr) {
  ...
  backend_regression_1 <- cmdstan_sample_SBC_backend(model_regression_1, iter_warmup = 400, iter_sampling = 500)
  backend_regression_2 <- cmdstan_sample_SBC_backend(model_regression_2, iter_warmup = 400, iter_sampling = 500)
  backend_regression_3 <- cmdstan_sample_SBC_backend(model_regression_3, iter_warmup = 400, iter_sampling = 500)
} else {
  ...
  backend_regression_1 <- rstan_sample_SBC_backend(model_regression_1, iter = 900, warmup = 400)
  backend_regression_2 <- rstan_sample_SBC_backend(model_regression_2, iter = 900, warmup = 400)
  backend_regression_3 <- rstan_sample_SBC_backend(model_regression_3, iter = 900, warmup = 400)
}
...
```{r}
set.seed(5666024)
datasets_regression <- generate_datasets(function_SBC_generator(single_dataset_regression, N = 100, K = 2), 10)
```
