...
if(use_cmdstanr) {
  ...
  backend_1 <- cmdstan_sample_SBC_backend(stan_model_1, iter_warmup = 400, iter_sampling = 500)
  backend_2 <- cmdstan_sample_SBC_backend(stan_model_2, iter_warmup = 400, iter_sampling = 500)
  backend_3 <- cmdstan_sample_SBC_backend(stan_model_3, iter_warmup = 400, iter_sampling = 500)
} else {
  ...
  backend_1 <- rstan_sample_SBC_backend(stan_model_1, iter = 900, warmup = 400)
  backend_2 <- rstan_sample_SBC_backend(stan_model_2, iter = 900, warmup = 400)
  backend_3 <- rstan_sample_SBC_backend(stan_model_3, iter = 900, warmup = 400)
}
