...
plot_rank_hist(results_logistic_first_10)
plot_ecdf_diff(results_logistic_first_10)
```

```{r}
plot_sim_estimated(results_logistic_first_10)
```
...
```{r}
plot_rank_hist(results_logistic_matrix_10)
plot_ecdf_diff(results_logistic_matrix_10)
```
