...
combined <- logistic_merged_intercept_ranks | logistic_merged_intercept_ecdf
ggsave(file.path(cache_dir, "sbcworkflow_logistic_merged_intercept_results.pdf"), combined)
```
