...
logistic_first_sim_estimated <- plot_sim_estimated(results_logistic_first_10) + labs(x = "Simulated value", y = "Mean, 90% CI") + coord_flip()
logistic_first_sim_estimated
ggsave(file.path(cache_dir, "sbcworkflow_logistic_first_sim_estimated.pdf"), logistic_first_sim_estimated, width = 6, height = 2.2)
```
...
results_combined <- compute_SBC(dataset_combined, backend_combined, 
                    keep_fits = FALSE, cache_mode = "results", 
                    cache_location = file.path(cache_dir, "combined_book"))
```
...
results_combined_reject <- compute_SBC(dataset_combined_reject, backend_combined, 
                    keep_fits = FALSE, cache_mode = "results", 
                    cache_location = file.path(cache_dir, "combined_reject_book"))
```
...
results_combined_reject_more <- bind_results(
  ...
  compute_SBC(dataset_combined_reject_more, backend_combined, 
                    keep_fits = FALSE, cache_mode = "results", 
                    cache_location = file.path(cache_dir, "combined_reject_book_more"))
)
```
...
sim_estimated_final <- plot_sim_estimated(results_combined_reject_more, alpha = 0.2) + labs(x = "Simulated value", y = "Mean, 90% CI") + coord_flip()
sim_estimated_final
