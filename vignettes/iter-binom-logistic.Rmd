...
rstan_backend_hmc <- SBC_backend_rstan_sample(rstan_mod, chains = 1, iter = ndraws / nchains + 10, warmup=10)
# TODO
...
result <- compute_results(datasets, rstan_backend_hmc, thin_ranks = 1)
