...
generator_gamma <- function_SBC_generator(single_dataset_gamma, N = 40)
...
if(use_cmdstanr) {
  ...
  backend_gamma_2 <- cmdstan_sample_SBC_backend(
  ...
  backend_gamma_2 <- rstan_sample_SBC_backend(
