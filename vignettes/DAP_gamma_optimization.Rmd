...
rownames(var_theta_tilde) <- mu_seq
colnames(var_theta_tilde_bar) <- var_seq
...
generated_Y <- array(rep(NA, nsims * nobs * gridsize_mu * gridsize_var), dim=c(nsims * nobs, gridsize_mu, gridsize_var) )
