...
res_turtles_w <- compute_SBC(ds_turtles[1:2], backend_turtles_warp, 
                           keep_fits = TRUE)
res_turtles_w$stats
# TODO: figure out how to update @.MISC in stanfit
```
...
plot_ecdf_diff(stats_split$stats_H1)
```
```{r}
plot_binary_calibration_diff(res_turtles$stats)
```
