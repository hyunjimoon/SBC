...
ggplot(B_df) + geom_point(aes(x=Mu, y=B_ghat, color="red")) + geom_line(aes(x=Mu, y=B_ghat, color="red", group=1)) + ggtitle("B") + geom_point(aes(x=Mu, y=B_g, color="green")) + geom_line(aes(x=Mu, y=B_g, group=2, color="green")) + theme(legend.position="none")
...
ggplot(V_df) + geom_point(aes(x=Mu, y=V_ghat, color="red")) + geom_line(aes(x=Mu, y=V_ghat, color="red", group=1)) + ggtitle("V(red=ghat)") + geom_point(aes(x=Mu, y=V_g, color="green")) + geom_line(aes(x=Mu, y=V_g, group=2, color="green")) + theme(legend.position="none")
