...
if(use_cmdstanr) {
  ...
  backend_1 <- cmdstan_sample_SBC_backend(model_1)
} else {
  model_1 <- stan_model(model_code = stan_code_1)
  backend_1 <- rstan_sample_SBC_backend(model_1)
}
...
generator_1 <- function_SBC_generator(generate_single_dataset_1, T = 5, r_e = 0.5, r_l = 0.1)
```
...
generator_2 <- function_SBC_generator(generate_single_dataset_2, T = 5, r_e = 0.5, r_l = 0.1)
```
